...
def generate_practice_questions(summary_text: str, num_questions: int=5) -> Quiz:
    prompt = f"Generate {num_questions} multiple-choice practice questions based on this summary:\n\n{summary_text}"
